...
Type: ${v.t||"other"}
${v.d||""}`}}else if(E.map.test(e))this.dispatchEvent(new CustomEvent("navigate",{detail:"map",bubbles:!0,composed:!0})),i="Switching to Map view 🗺️";else if(E.timeline.test(e))this.dispatchEvent(new CustomEvent("navigate",{detail:"timeline",bubbles:!0,composed:!0})),i="Switching to Timeline view 📅";else if(E.language.test(e))i="Language toggle is in the top-right corner of the header.";else if(E.dynasty.test(e)){const m=((b=(h=this.data)==null?void 0:h.nodes)==null?void 0:b.filter(v=>{const w=((v.l||"")+" "+(v.lv||"")+" "+(v.d||"")).toLowerCase();return w.includes("dynasty")||w.includes("triều")||w.includes("nhà")}))||[];m.length?i=`👑 Found ${m.length} dynasties:
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ce={CHILD:2},De=r=>(...t)=>({_$litDirective$:r,values:t});class Te{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class gt extends Te{constructor(t){if(super(t),this.it=$,t.type!==Ce.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===$||t==null)return this._t=void 0,this.it=t;if(t===N)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}gt.directiveName="unsafeHTML",gt.resultType=1;const Pe=De(gt);class ut extends k{constructor(){super(),this._enriched=null,this._loading=!1,this._lang="en",this.ready=!1}updated(t){t.has("ready")&&this.ready&&this.entityId&&!this._enriched&&this._load()}async _load(){this._loading=!0,this.requestUpdate();try{this._enriched=await ne(this.entityId,{l:this.label})}catch(t){console.warn("WP load:",t)}this._loading=!1,this.requestUpdate()}_switchLang(t){this._lang=t,this.requestUpdate()}render(){var f,p,u,h,b,c,_,m;const t=bt();t!==this._lang&&(this._lang=t);const e=this._lang==="en"?(f=this._enriched)==null?void 0:f.fullEn:((p=this._enriched)==null?void 0:p.fullVi)||((u=this._enriched)==null?void 0:u.fullEn),i=this._lang==="en"?(h=this._enriched)==null?void 0:h.wikipediaEn:((b=this._enriched)==null?void 0:b.wikipediaVi)||((c=this._enriched)==null?void 0:c.wikipediaEn),s=e==null?void 0:e.paragraphs,a=i==null?void 0:i.extract,o=i==null?void 0:i.thumbnail,l=i==null?void 0:i.url,n=(i==null?void 0:i.title)||"",g=!!((_=this._enriched)!=null&&_.wikipediaVi||(m=this._enriched)!=null&&m.fullVi);return this._loading?d`<div class="wp-card"><div class="wp-loading"><span class="wp-spinner"></span>Loading Wikipedia...</div></div>`:!s&&!a?d``:d`
      <div class="wp-card">
        <div class="wp-header">
          ...
          <div style="margin-left:auto;display:flex;gap:4px">
            ...
            ${g?d`<button @click=${()=>this._switchLang("vi")} style="border:none;background:${this._lang==="vi"?"var(--a1)":"transparent"};color:${this._lang==="vi"?"#fff":"var(--text3)"};padding:2px 8px;border-radius:3px;cursor:pointer;font-size:0.62rem;font-family:inherit">VI</button>`:""}
          </div>
        </div>
        <div class="wp-body">
  ...
  `),x(ut,"properties",{entityId:{},label:{},ready:{}});customElements.define("mini-wikipedia",ut);function Ue(r){if(!r)return null;if(r.m){for(const t of["image","commons_image","flag_image","seal_image","coat_of_arms_image"]){const e=r.m[t];if(e&&typeof e=="string"){const i=e.replace(/^File:/,"").replace(/\s/g,"_");return`https://commons.wikimedia.org/wiki/Special:FilePath/${encodeURIComponent(i)}?width=600`}}for(const[t,e]of Object.entries(r.m))if(typeof e=="string"&&(t.includes("image")||t.includes("photo")||t.includes("flag")||t.includes("seal")||t.includes("coat"))&&e.length<200){const i=e.replace(/^File:/,"").replace(/\s/g,"_");return`https://commons.wikimedia.org/wiki/Special:FilePath/${encodeURIComponent(i)}?width=600`}}return null}function Rt(r){return!!(r!=null&&r.m&&(r.m.coordinates||r.m.coord))}function Me(r){var a,o;const t=((a=r.m)==null?void 0:a.coordinates)||((o=r.m)==null?void 0:o.coord);if(!t)return null;const e=String(t).match(/(-?\d+\.?\d*)\s*[,\s]\s*(-?\d+\.?\d*)/);if(!e)return null;const i=parseFloat(e[1]),s=parseFloat(e[2]);return isNaN(i)||isNaN(s)?null:{lat:i,lng:s}}class ft extends k{constructor(){super(),this._activeTab="overview",this._enriched=null,this._loading=!1,this._detailMap=null}updated(t){t.has("node")&&(this._enriched=null,this._loading=!0,this.node&&this._doEnrich(this.node)),t.has("node")&&this.node&&this._activeTab==="map"&&requestAnimationFrame(()=>this._initDetailMap())}async _doEnrich(t){this._loading=!0;try{const e=await Nt(t.id,t);this._enriched=e}catch(e){console.warn("Enrichment error:",e),this._enriched=null}this._loading=!1,this.requestUpdate()}_switchTab(t){this._activeTab=t,this.requestUpdate(),t==="map"&&requestAnimationFrame(()=>this._initDetailMap())}_navigateTo(t){this.dispatchEvent(new CustomEvent("navigate-detail",{detail:t,bubbles:!0,composed:!0}))}_initDetailMap(){if(typeof L>"u")return;const t=this.shadowRoot.getElementById("detail-map");if(!t||this._detailMap)return;const e=Me(this.node);if(e){if(!this.shadowRoot.querySelector("#leaflet-tile-style")){const i=document.createElement("style");i.id="leaflet-tile-style",i.textContent=".leaflet-container{height:100%;width:100%}.leaflet-tile{visibility:hidden;position:absolute}.leaflet-tile-loaded{visibility:inherit}.leaflet-tile-pane{z-index:2}.leaflet-popup-pane{z-index:8}.leaflet-control{position:relative;z-index:800}.leaflet-top,.leaflet-bottom{position:absolute;z-index:1000}.leaflet-top{top:0}.leaflet-bottom{bottom:0}.leaflet-left{left:0}.leaflet-right{right:0}.leaflet-control-zoom{display:inline-block}.leaflet-control-zoom a{display:block;width:30px;height:30px;text-align:center;text-decoration:none;color:#000;background:#fff;border-bottom:1px solid #ccc;line-height:30px;font-size:18px}.leaflet-popup-content-wrapper{padding:1px;text-align:left;border-radius:8px;background:#fff;color:#333}.leaflet-popup-content{margin:8px 12px;line-height:1.4;font-size:13px;font-family:-apple-system,sans-serif}.leaflet-popup-close-button{position:absolute;top:4px;right:4px;width:18px;height:18px;text-align:center;font:16px/18px sans-serif;color:#c3c3c3;text-decoration:none;border:none;background:transparent;cursor:pointer}.leaflet-attribution-flag{display:none!important}",this.shadowRoot.appendChild(i)}this._detailMap=L.map(t,{zoomControl:!0}).setView([e.lat,e.lng],10),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:18}).addTo(this._detailMap),L.circleMarker([e.lat,e.lng],{radius:8,color:"#6366f1",fillColor:"rgba(99,102,241,0.4)",fillOpacity:.8,weight:2}).addTo(this._detailMap).bindPopup(`<b>${this.node.l}</b>`)}}render(){var f,p,u,h,b;if(!this.node)return d`<div class="empty-state">${y("noResults")}</div>`;const t=this.node,e=this._enriched,i=(f=e==null?void 0:e.wikidata)==null?void 0:f.image,s=((p=e==null?void 0:e.wikipediaEn)==null?void 0:p.thumbnail)||((u=e==null?void 0:e.wikipediaVi)==null?void 0:u.thumbnail)||((h=e==null?void 0:e.wikipediaEn)==null?void 0:h.originalImage),a=i||Ue(t)||s,o=this._loading,l=this.edges?this.edges.filter(c=>c.s===t.id).slice(0,80):[],n=[];if(t.id&&n.push({label:"WikiData ID",value:t.id}),t.m){const c=new Set(["image","commons_image","flag_image","seal_image","coordinates","coord"]);for(const[_,m]of Object.entries(t.m))c.has(_)||typeof m=="string"&&m.length<120&&n.push({label:_.replace(/_/g," "),value:m})}const g=[{id:"overview",label:y("details")||"Overview",icon:"ℹ️"},{id:"properties",label:"Properties",icon:"📋"},{id:"relations",label:`${y("relations")||"Relations"} (${l.length})`,icon:"🔗"}];return Rt(t)&&g.push({id:"map",label:"Map",icon:"🗺"}),d`
      <div class="page">
        ...
        <div class="tabs">${g.map(c=>d`<button class="tab ${this._activeTab===c.id?"active":""}" @click=${()=>this._switchTab(c.id)}>${c.icon} ${c.label}</button>`)}</div>
        ...
        <div class="tab-content">
          ...
          ${this._activeTab==="map"&&Rt(t)?d`<div id="detail-map" class="map-container"></div>`:""}
        </div>
      </div>
    `}}x(ft,"styles",z`
    :host { display: block; }
  ...
  `),x(ft,"properties",{node:{},edges:{}});customElements.define("mini-detail",ft);class mt extends k{constructor(){super(),this._nodes=[],this._edges=[],this._hovered=null,this._zoom=1,this._panX=0,this._panY=0,this._isDragging=!1,this._dragStartX=0,this._dragStartY=0,this._panStartX=0,this._panStartY=0,this._W=0,this._H=0,this._positions={},this._velocities={}}firstUpdated(){this.data&&this._build()}updated(t){t.has("data")&&this.data&&this._build()}_screenToWorld(t,e){return{x:(t-this._W/2)/this._zoom-this._panX,y:(e-this._H/2)/this._zoom-this._panY}}_worldToScreen(t,e){return{x:(t+this._panX)*this._zoom+this._W/2,y:(e+this._panY)*this._zoom+this._H/2}}_build(){var p,u;if(!((p=this.data)!=null&&p.nodes)||!((u=this.data)!=null&&u.edges))return;const t={};this.data.edges.forEach(h=>{t[h.s]=(t[h.s]||0)+1,t[h.t]=(t[h.t]||0)+1});const e=[...this.data.nodes].sort((h,b)=>(t[b.id]||0)-(t[h.id]||0)),i=new Set(e.slice(0,200).map(h=>h.id));this._nodes=this.data.nodes.filter(h=>i.has(h.id));const s=new Set;this._edges=this.data.edges.filter(h=>{if(!i.has(h.s)||!i.has(h.t))return!1;const b=h.s+":"+h.t;return s.has(b)?!1:(s.add(b),!0)});const a=this.shadowRoot.querySelector("canvas");if(!a)return;const o=a.getContext("2d"),l=window.devicePixelRatio||1,n=a.getBoundingClientRect();a.width=n.width*l,a.height=n.height*l,o.scale(l,l),this._W=n.width,this._H=n.height,this._positions={},this._velocities={};const g=this._nodes.length,f=Math.min(this._W,this._H)*.35;this._nodes.forEach((h,b)=>{const c=b/g*Math.PI*2;this._positions[h.id]={x:Math.cos(c)*f*(.5+Math.random()*.5),y:Math.sin(c)*f*(.5+Math.random()*.5)},this._velocities[h.id]={x:0,y:0}});for(let h=0;h<80;h++){const b={};this._nodes.forEach(c=>{b[c.id]={x:0,y:0},this._nodes.forEach(_=>{if(_.id===c.id)return;const m=this._positions[c.id].x-this._positions[_.id].x,v=this._positions[c.id].y-this._positions[_.id].y,w=Math.sqrt(m*m+v*v)||1,P=5e3/(w*w);b[c.id].x+=m/w*P,b[c.id].y+=v/w*P}),b[c.id].x+=-this._positions[c.id].x*.01,b[c.id].y+=-this._positions[c.id].y*.01}),this._edges.forEach(c=>{const _=this._positions[c.s],m=this._positions[c.t];if(!_||!m)return;const v=m.x-_.x,w=m.y-_.y,S=(Math.sqrt(v*v+w*w)||1)*.005;b[c.s].x+=v*S,b[c.s].y+=w*S,b[c.t].x-=v*S,b[c.t].y-=w*S}),this._nodes.forEach(c=>{this._velocities[c.id].x=(this._velocities[c.id].x+b[c.id].x)*.7,this._velocities[c.id].y=(this._velocities[c.id].y+b[c.id].y)*.7,this._positions[c.id].x+=this._velocities[c.id].x,this._positions[c.id].y+=this._velocities[c.id].y})}this._draw()}_draw(){const t=this.shadowRoot.querySelector("canvas");if(!t)return;const e=t.getContext("2d");e.clearRect(0,0,this._W,this._H),e.save(),e.translate(this._W/2,this._H/2),e.scale(this._zoom,this._zoom),e.translate(this._panX,this._panY);const i=st(this);e.strokeStyle=i.edge,e.lineWidth=.5/this._zoom,this._edges.forEach(s=>{const a=this._positions[s.s],o=this._positions[s.t];!a||!o||(e.beginPath(),e.moveTo(a.x,a.y),e.lineTo(o.x,o.y),e.stroke())}),this._nodes.forEach(s=>{const a=this._positions[s.id];if(!a)return;const o=st(this)[s.t]||"#64748b",n=(s.id===this._hovered?8:5)/this._zoom;e.beginPath(),e.arc(a.x,a.y,n,0,Math.PI*2),e.fillStyle=o,e.globalAlpha=.7,e.fill(),e.globalAlpha=1,s.id===this._hovered&&(e.strokeStyle=i.text,e.lineWidth=2/this._zoom,e.stroke(),e.fillStyle=i.text,e.font=12/this._zoom+"px Inter, sans-serif",e.textAlign="center",e.fillText(s.l,a.x,a.y-n-6/this._zoom))}),e.restore()}_onWheel(t){t.preventDefault();const e=this.shadowRoot.querySelector("canvas").getBoundingClientRect(),i=t.clientX-e.left,s=t.clientY-e.top,a=t.deltaY<0?1.12:.88,o=Math.max(.2,Math.min(10,this._zoom*a));this._panX-=(i/this._zoom-i/o)/o,this._panY-=(s/this._zoom-s/o)/o,this._zoom=o,this._draw()}_onDragStart(t){this._isDragging=!0,this._dragStartX=t.clientX,this._dragStartY=t.clientY,this._panStartX=this._panX,this._panStartY=this._panY}_onDragMove(t){this._isDragging&&(this._panX=this._panStartX+(t.clientX-this._dragStartX)/this._zoom,this._panY=this._panStartY+(t.clientY-this._dragStartY)/this._zoom,this._draw())}_onDragEnd(){this._isDragging=!1}_onHover(t){const e=this.shadowRoot.querySelector("canvas").getBoundingClientRect(),i=t.clientX-e.left,s=t.clientY-e.top,a=this._screenToWorld(i,s);let o=null;const l=144/(this._zoom*this._zoom);for(const g of this._nodes){const f=this._positions[g.id];if(!f)continue;const p=f.x-a.x,u=f.y-a.y;if(p*p+u*u<l){o=g;break}}this._hovered=(o==null?void 0:o.id)||null,this._draw();const n=this.shadowRoot.querySelector(".info");n&&(n.textContent=o?`${o.l}${o.lv?" ("+o.lv+")":""} — ${o.t||"other"}`:"")}render(){return d`
      <div class="legend">
  ...
  `);customElements.define("mini-options",Wt);class vt extends k{constructor(){super();const t=C();this._cfg=t,this.data=null,this.loaded=!1,this.progress=0,this.totalSize=0,this.currentView="search",this.entityDetail=null,this.bm25=null,this.searchQuery="",this.searchFilter="all",this._pendingEntityFromUrl=null,this._loadData(),this._initRouting()}_initRouting(){const t=location.hash.substring(1);if(t)this._pendingEntityFromUrl=t;else{const e=new URLSearchParams(location.search),i=e.get("entity");i&&(this._pendingEntityFromUrl=i.split("/")[0]),e.has("view")&&(this.currentView=e.get("view"))}window.addEventListener("hashchange",()=>{var i,s;const e=location.hash.substring(1);if(e){const a=(s=(i=this.data)==null?void 0:i.nodes)==null?void 0:s.find(o=>o.id===e);a&&(this.entityDetail=a,this.currentView="detail",this.requestUpdate())}else this.currentView="search",this.entityDetail=null,this.requestUpdate()}),window.addEventListener("popstate",()=>{var e,i,s;if(!location.hash){const a=new URLSearchParams(location.search);if(a.has("entity")){const o=(e=a.get("entity"))==null?void 0:e.split("/")[0],l=(s=(i=this.data)==null?void 0:i.nodes)==null?void 0:s.find(n=>n.id===o);l&&(this.entityDetail=l,this.currentView="detail",this.requestUpdate())}else this.currentView=a.get("view")||"search",this.entityDetail=null,this.requestUpdate()}})}_pushUrl(){this.currentView==="detail"&&this.entityDetail?location.hash!=="#"+this.entityDetail.id&&(location.hash=this.entityDetail.id):location.hash&&history.pushState("",document.title,location.pathname+location.search)}async _loadData(){try{if(this.data=await Qt((t,e)=>{this.progress=t,this.totalSize=e},this._cfg.dataPath),this.loaded=!0,this.bm25=te(this.data.nodes),this._pendingEntityFromUrl){const t=this.data.nodes.find(e=>e.id===this._pendingEntityFromUrl);t&&(this.entityDetail=t,this.currentView="detail",this._pendingEntityFromUrl=null)}}catch(t){console.error("Failed to load data:",t)}}_onNavigate(t){const e=t.detail;this.currentView=e,e!=="detail"&&(this.entityDetail=null),this._pushUrl()}_onSearchInput(t){this.searchQuery=t,this.currentView="search"}_onFilterType(t){this.searchFilter=t.detail.filter,this.searchQuery=t.detail.query||"",this.currentView="search"}_onLangChanged(){this.requestUpdate()}_onShowDetail(t){const e=t.detail,i=this.data.nodes.find(s=>s.id===e);i&&(this.entityDetail=i,this.currentView="detail",this._pushUrl())}_onNavigateDetail(t){this._onShowDetail({detail:t.detail})}render(){const t=this._cfg;if(!this.loaded){const i=this.totalSize?Math.round(this.progress/this.totalSize*100):0;return d`
        <div class="splash">
